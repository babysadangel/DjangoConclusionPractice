...
class  Dept(models.Model):
    ...
    #部门类
    no = models.Integer(primary_key = True, db_column = 'dno',verbose_name = '部门编号')
...
class emp(models.Model):
    #员工类
    no = models.IntegerField(primary_key=True, db_colum='eno', verbose_name='员工编号')
    ...
    sal = models.DecimalField(max_digits=7,decimal_place=2, verbose_name='月薪')
    comm = models.DecimalField(max_digits=7, decimal_places=2, null=True, blank=True,verbose_name='补贴')
    #多对一外键关联
    dept  =models.ForeignKey(Dept, db_column='don', on_delete=models.PROTECT, verbose_name='所在部门')
